        ...
        <>
          <Card.Group centered itemsPerRow='2'>
            <Card style={{
              ...
              boxShadow: '0 10px 20px rgba(0, 0, 0, 0.5), 0 10px 25px rgba(0, 0, 0)',
          ...
          <Card.Group centered itemsPerRow='4'>
            <Card style={{
              ...
              backdropFilter: "blur('400px')",
              filter: 'drop-shadow(0px 0px 40px rgba(130, 55, 222, 0.8)) blur("0.7px")',
              boxShadow: '0 10px 20px rgba(0, 0, 0, 0.8), 0 10px 25px rgba(0, 0, 0)',
              border: '1px solid rgba(255, 255, 255, 0.5)',
              borderRight: '1px solid rgba(255, 255, 255,0.5)',
              borderBottom: '1px solid rgba(255, 255, 255, 0.5)',
              borderRadius: '25px',
          ...
          <Segment style={{
            ...
            backdropFilter: "blur('400px')",
            filter: 'drop-shadow(0px 0px 40px rgba(130, 55, 222, 0.8)) blur("0.7px")',
            boxShadow: '0 12px 22px rgba(0, 0, 0, 0.8), 0 12px 30px rgba(0, 0, 0)',
            border: '1px solid rgba(255, 255, 255, 0.5)',
            borderRight: '1px solid rgba(255, 255, 255,0.5)',
            borderBottom: '1px solid rgba(255, 255, 255, 0.5)',
            borderRadius: '25px',
